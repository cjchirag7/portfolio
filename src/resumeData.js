let resumeData = {
  ...
  socialLinks: [
    {
      name: 'linkedin',
      url: 'https://www.linkedin.com/in/cjchirag7/',
      className: 'fa fa-linkedin',
    },
    {
      name: 'github',
      url: 'http://github.com/cjchirag7',
      className: 'fa fa-github',
    },
    {
      name: 'facebook',
      url: 'https://www.facebook.com/profile.php?id=100005981172975',
      className: 'fa fa-facebook',
    },
    {
      name: 'mail',
      url: 'mailto:cjchirag7@gmail.com',
